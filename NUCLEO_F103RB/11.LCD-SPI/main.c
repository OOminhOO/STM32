...
int main(void)
{
  ...
  LCD_DrawString(10, 30, "MINHO!", WHITE, BLACK);
  LCD_DrawString(10, 45, "LET'S GO", GREEN, BLACK);
  LCD_DrawString(10, 60, "BREAK THE WORLD", CYAN, BLACK);
  LCD_DrawString(10, 75, "I LOVE YOU", YELLOW, BLACK);
  LCD_DrawString(10, 90, "LOVE THE WORLD",RED , BLACK);
