...
### SG90_ServoMotor 제어를 위한 타이머 설정 및 각도 설정
...
f_timer = 64,000,000 / 1280 = 50,000 Hz
카운터 주파수 : 50k Hz

Tick 주기 = 20 us ( 1 / 50,000 )

---

## 3. PWM 주기

PWM = (Period+1) / f_timer = 1000/50,000 = 0.02s = 20ms
